...
public class JobProviderRatingMenuTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void jobProviderRatingMenuTest() {
        ...
        ViewInteraction button = onView(
                allOf(withId(R.id.btn_rate_seeker),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction button2 = onView(
                allOf(withId(R.id.btn_view_my_ratings_provider),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
                                        1),
