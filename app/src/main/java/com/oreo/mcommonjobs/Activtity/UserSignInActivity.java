...
import com.oreo.mcommonjobs.RequestSingleton;
...
/**
 * UserSignInActivity connects to Google API to allow a user to sign in.
 */
public class UserSignInActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (result.isSuccess()) {
                ...
                session.setGoogleFirstName(googleAccount.getGivenName());
                session.setGoogleLastName(googleAccount.getFamilyName());
